...
export class UploadProjectComponent implements OnInit {
                ...
                [
                    {
                        ...
                        "value": "commerce",
                        "father": "",
                        "explanation": "retail, commodoties, stuff"
                    },
                    ...
                    {"label": "Education", "value": "education", "father": "", "explanation": "teach them to fish"},
                    {
                        ...
                        "value": "entertainment",
                        "father": "",
                        "explanation": "entertain the people"
                    },
                    ...
                    {"label": "Legal", "value": "legal", "father": "", "explanation": "I am the law"},
                    {
                        ...
                        "value": "finance",
                        "father": "",
                        "explanation": "blockchain, stocks, finance"
                    },
                    {
                        "label": "Security",
                        "value": "security",
                        "father": "",
                        "explanation": "cyber, monitoring, anomalies"
                    },
                ]
        },
        {
            ...
            "options":
                [
...

                    {
                        ...
                        "value": "application",
                        "father": "develop",
                        "explanation": "a mobile application"
                    },
                    ...
                    {"label": "API", "value": "api", "father": "develop", "explanation": "an api"},
                    {
                        ...
                        "value": "software tool",
                        "father": "develop",
                        "explanation": "general software"
                    },
                    {
                        "label": "HW prototype",
                        "value": "hw prototype",
                        "father": "develop",
                        "explanation": "something physical"
                    },
                    {
                        "label": "Application",
                        "value": "application",
                        "father": "design",
                        "explanation": "a mobile application ux/design"
                    },
                    ...
                    },
                    {
                        ...
                        "value": "building",
                        "father": "design",
                        "explanation": "architectural plans"
                    },
                    {
                        "label": "Application",
                        "value": "application",
            ...
            "options":
                [
                    ...
                    {"label": "Wix", "value": "wix", "father": "design", "explanation": "proficiancy with wix"},
                    {
                        ...
                        "value": "autocad",
                        "father": "design",
                        "explanation": "proficiancy with autocad"
                    },
                    {
                        "label": "Wireframe",
                        "value": "wireframe",
                        "father": "design",
                        "explanation": "proficiancy with wireframe"
                    },
                    {"label": "IOS", "value": "ios", "father": "develop", "explanation": "ios development background"},
                    {
                        ...
                        "value": "android",
                        "father": "develop",
                        "explanation": "android development background"
                    },
                    ...
                    {"label": "Manual", "value": "manual", "father": "test", "explanation": "manual testing"},
                    {
                        ...
                        "value": "automation",
                        "father": "test",
                        "explanation": "develop automatic tests"
                    },
                ]
        },
    ...
    finishClick() {
        ...
        this.http.post('/api/projects', data).subscribe(returned_data => {
                console.log(returned_data);
                this.skills = returned_data;
            this.dataService.ChosenProject = returned_data;
