...
class CompaniesRanking(object):
    def __init__(self):
        self.companiesList = { "company_types": [
            ...
            "telegram","canva","box","evernote","wordpress-foundation","wordstream",
            "jetbrains","cisco","atlassian","basecamp","ccleaner","pluralsight","eset","monday-com-monday-com","aws","asana","epic-systems-corporation",
            "paychex-inc","square","zendesk","activecampaign","paylocity","outsystems","linkedin","snagit","intercom","instructure","apple",
            "bluejeans","infusionsoft","teamviewer","canonical-ltd","doodle","endurance-international-group","logmein","sodexo","prezi",
            "domo","zoho-corporation-pvt-ltd","autodesk","hootsuite","adp","birdeye","1password","basis","acuity-scheduling","livechat",
